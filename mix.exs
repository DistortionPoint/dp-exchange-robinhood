defmodule DpExchangeRobinhood.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      # Hex.pm
      name: "DpExchangeRobinhood",
      description:
        "EXPERIMENTAL — Robinhood venue package for the DpExchange family. Market data, " <>
  ...
  # consumer that has not asked for Robinhood must not find a socket open.
  def application do
